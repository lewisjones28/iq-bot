...
from iq_bot_global.constants import API_DEFAULTS
    ...
    def generate_response(self, prompt_data: str, system: str) -> str:
        ...
        try:
            ...
            response = self.client.chat.completions.create(
                model=os.getenv("OPENAI_MODEL") or API_DEFAULTS.MODEL,
                messages=[
                    {"role": "system", "content": system},
                    {"role": "user", "content": prompt_data}
                ],
                temperature=API_DEFAULTS.TEMPERATURE  # Randomness & Creativity (1.0 for full randomness)
            )
